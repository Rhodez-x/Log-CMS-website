<?php
    echo '<footer class="container text-center" style="border-radius: 0px 0px 10px 10px; margin-bottom:50px; background-color:#bbb1a9;">
    ...
    include $_SERVER['DOCUMENT_ROOT']. "/REPLACE_ME_PATH/" .$sidenssti.$sidenspecialescript;
?>
