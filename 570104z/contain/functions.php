...
function menu_line($active){
    $tabs=array("Admin side"=> 'REPLACE_ME_PATH/570104z/index', "Indstillinger" => '/570104z/setup', "Rediger side" => 'REPLACE_ME_PATH/570104z/site_editor', "Master control" => 'REPLACE_ME_PATH/570104z/master_control');
